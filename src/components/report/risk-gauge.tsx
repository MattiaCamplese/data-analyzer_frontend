  ...
  return (
    <Card className={cn("shadow-none dark:ring-0", className)}>
      ...
      <CardContent className="flex flex-col items-center gap-2">
        <svg viewBox="20 15 200 125" className="w-full max-w-48">
          ...
          <text x={cx} y={cy - 4} textAnchor="middle" dominantBaseline="middle" fontSize="40" fontWeight="700" fill="currentColor">
            {clamped}
          </text>
          <text x={cx} y={cx + 22} textAnchor="middle" fontSize="11" fontWeight="600" fill={risk.hex} letterSpacing="2">
            {risk.label}
          </text>
        </svg>
